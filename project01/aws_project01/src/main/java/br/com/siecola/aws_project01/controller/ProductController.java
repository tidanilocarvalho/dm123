...
public class ProductController {
    ...
    public ResponseEntity<Product> saveProduct(@RequestBody @Valid Product product) {
        ...
        productPublisher.publishProductEvent(productCreated, EventType.PRODUCT_CREATED, "DaniloCarvalho");
    ...
    public ResponseEntity<Product> updateProduct( @RequestBody @Valid Product product, @PathVariable("id") long id) {
        if (productRepository.existsById(id)) {
            ...
            productPublisher.publishProductEvent(productUpdated, EventType.PRODUCT_UPDATE, "DaniloCarvalho");
    ...
    public ResponseEntity<Product> deleteProduct(@PathVariable("id") long id) {
        ...
        if (optProduct.isPresent()) {
            ...
            productPublisher.publishProductEvent(product, EventType.PRODUCT_DELETED, "DaniloCarvalho");
